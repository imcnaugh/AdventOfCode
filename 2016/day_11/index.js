...
moveElevatorToFloor(0)
moveFromFloorToElevator('e-g')
moveElevatorToFloor(3)
moveFromElevatorToFloor('e-g')
moveElevatorToFloor(0)
moveFromFloorToElevator('d-g')
moveElevatorToFloor(3)
moveFromElevatorToFloor('d-g')
...
moveElevatorToFloor(3)
moveFromElevatorToFloor('p-g')
moveFromElevatorToFloor('p-m')
moveFromFloorToElevator('e-g')
moveElevatorToFloor(0)
moveFromFloorToElevator('e-m')
moveElevatorToFloor(3)
moveFromElevatorToFloor('e-g')
moveFromElevatorToFloor('e-m')
moveFromFloorToElevator('d-g')
moveElevatorToFloor(0)
moveFromFloorToElevator('d-m')
moveElevatorToFloor(3)
